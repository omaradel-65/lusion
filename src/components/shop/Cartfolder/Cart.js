...
<div className="carttt">
      ...
      {props.totalQuantity ? (
        ...
        <Container>
          ...
          <button className="btn1cart" onClick={() => props.clearcart()} >Clear Cart</button>

          <Link to="/Productss" > <button className="btn2cart">UPDATE CART</button></Link>
          </div>
...
<Row >
            ...
            <div className="totalll">
              <div><h5>Subtotal</h5> <p>${props.total}</p></div>

              <div><h5>Total Items</h5> <p>${props.totalQuantity}</p></div>
